...
click_not_available = pytest.mark.skipif(is_click_available(), reason="Skip if click is available")
...
requests_not_available = pytest.mark.skipif(
...
urllib3_available = pytest.mark.skipif(not is_urllib3_available(), reason="Requires urllib3")
urllib3_not_available = pytest.mark.skipif(
